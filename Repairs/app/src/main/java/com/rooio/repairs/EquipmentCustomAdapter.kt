...
class EquipmentCustomAdapter(private val applicationContext: Context, private val dataList: ArrayList<EquipmentData>, private val equipmentId: Int):
        RecyclerView.Adapter<EquipmentCustomAdapter.MyViewHolder>() {
